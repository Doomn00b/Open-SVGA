  ...
  always @*
	begin
		case({bpp, hactive_regist}) 
		  ...
		  // 
  		  {2'b01, hactv8_780}:   horiz_actv_decode = 3'b010;
  		  {2'b10, hactv16_780}:  horiz_actv_decode = 3'b010;
  		  {2'b00, hactv32_780}:  horiz_actv_decode = 3'b010;
  		  {2'b11, hactv32_780}:  horiz_actv_decode = 3'b010;
		  // 
  		  {2'b01, hactv8_800}:   horiz_actv_decode = 3'b010;
  		  {2'b10, hactv16_800}:  horiz_actv_decode = 3'b010;
  		  {2'b00, hactv32_800}:  horiz_actv_decode = 3'b010;
  		  {2'b11, hactv32_800}:  horiz_actv_decode = 3'b010;
		  // 
  		  {2'b01, hactv8_1024}:  horiz_actv_decode = 3'b011;
  		  {2'b10, hactv16_1024}: horiz_actv_decode = 3'b011;
  		  {2'b00, hactv32_1024}: horiz_actv_decode = 3'b011;
  		  {2'b11, hactv32_1024}: horiz_actv_decode = 3'b011;
		  // 
